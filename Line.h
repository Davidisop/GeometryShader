...
bool  Line_Axis_s::Set_VertexData(D3DXVECTOR3 start_in, D3DXVECTOR3 end_in, D3DXVECTOR4 color_in)
{
	m_VertexList.resize(2);
	
	m_VertexList[0].p = start_in;   m_VertexList[0].c = color_in; m_VertexList[0].t = D3DXVECTOR2(0.0f, 0.0f);
	m_VertexList[1].p = end_in;   m_VertexList[1].c = color_in; m_VertexList[1].t = D3DXVECTOR2(1.0f, 1.0f);
