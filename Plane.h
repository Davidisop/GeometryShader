...
bool  Plane:: Set_VertexData()
{
	...
	int iner_index = 0;
	m_VertexList[iner_index++] = { D3DXVECTOR3(-1.0f, 1.0f, 0.0f), D3DXVECTOR4(0.0f, 0.0f, 0.0f, 0.5f), D3DXVECTOR2(0.0f, 0.0f) };
	m_VertexList[iner_index++] = { D3DXVECTOR3(1.0f, 1.0f, 0.0f), D3DXVECTOR4(1.0f, 0.0f, 1.0f, 0.5f), D3DXVECTOR2(1.0f, 0.0f) };
	m_VertexList[iner_index++] = { D3DXVECTOR3(-1.0f, -1.0f, 0.0f), D3DXVECTOR4(0.0f, 1.0f, 0.0f, 0.5f), D3DXVECTOR2(0.0f, 1.0f) };
	m_VertexList[iner_index++] = { D3DXVECTOR3(1.0f, -1.0f, 0.0f), D3DXVECTOR4(1.0f, 1.0f, 1.0f, 0.5f), D3DXVECTOR2(1.0f, 1.0f) };
