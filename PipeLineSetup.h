...
public:
	...
	bool PreRender(ID3D11DeviceContext* pContext, D3D_PRIMITIVE_TOPOLOGY m_Primitive_in = D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST)
	{
		...
		pContext->VSSetConstantBuffers(7, 1, &m_pConstantBuffer);
		...
		pContext->PSSetShaderResources(5, 1, &m_pTextureSRV);
		pContext->PSSetShader(m_pPixelShader, NULL, NULL);//0
		pContext->PSSetSamplers(13, 1, &m_pSamplerState);
	...
	bool Render(ID3D11DeviceContext* pContext, UINT counts_indexes, D3D_PRIMITIVE_TOPOLOGY m_Primitive_in = D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST)
	{
